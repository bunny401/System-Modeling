...
import hu.bme.mit.inf.symod.IQULTE.homework.chessclockiqulte.*;
import hu.bme.mit.inf.symod.IQULTE.homework.chessclockiqulte.IChessClockIQULTEStatemachine.SCIBeeperOperationCallback;

public class TesterAPI {
	protected ChessClockIQULTEStatemachine chessClock;
	...
	public TesterAPI(String name, String description) {
		...
		this.name = name;
		this.log = "\n" + name + "\n----------\n";
		chessClock = new ChessClockIQULTEStatemachine();
